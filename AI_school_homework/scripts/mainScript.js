...
(function() {
    app.router = Sammy(function () {
        ...
        this.get('#/danger', function(){
            var html = '<section>' +
                            '<article>През юли 2015 г. над 1000 водещи изследователи в областта на роботиката и изкуствения интелект подписаха отворено писмо, в което предупредиха за опасността от употребата на изкуствен интелект за военни цели и автономни оръжия. Сред подписалите личности са основателя на “Тесла” Елон Мъск, съоснователя на “Apple” Стив Возняк и Стивън Хокинг.' +
                'Фундаменталният въпрос е: как можем да измерим точно колко умни са машините, така че да ги съпоставим със собствения ни мозък и логичното последствие дали и кога ще дойде моментът, когато изкуственият интелект би могъл да се превърне от помощник в опасност, от служител в господар.' +
                            '</article>' +
                        '</section>';
            $(selector).html(html);
        });
